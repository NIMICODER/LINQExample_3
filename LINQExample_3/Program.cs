...
namespace LINQExample_3
{
     class Program
    {
        ...
        static void ProjectionOperator()
        {
            ...
            List<Department> departmentList = Data2 .GetDepartments(employeeList);
        ...
        static void PartitioningOperator()
        {
            List<Employee> employeeList = Data.GetEmployees();
            List<Department> departmentList = Data.GetDepartments();
        ...
        static void GeneratorOperator() 
        {
            ...
            //var newList = intList.DefaultIfEmpty(99999999);
        ...
        static void AggregatorOperator()
        {
            List<Employee> employeeList = Data.GetEmployees();
            List<Department> departmentList = Data.GetDepartments();

            ////Aggregate Operators - Aggregate, Average, Count,
            /////Aggregate Operator
            ...
            //decimal average = employeeList.Where(e => e.DepartmentId == 2).Average(e => e.AnnualSalary);

            //Console.WriteLine($"Average Annual Salary (Technology Department): {average}");

            ////Count
            //int countEmployees = employeeList.Count(e => e.IsManager);
